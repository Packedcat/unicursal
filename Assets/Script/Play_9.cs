...
public class Play_9 : MonoBehaviour
{
    ...
    public GameObject[,] cubeArray = new GameObject[9, 9];
    public bool[,] tempArray = new bool[9, 9];
    ...
    void Start()
    {
        ...
        {
            Label_BestScore.GetComponent<UILabel>().text = PlayerPrefs.GetInt("StrokeGrade_9", 0).ToString();
            Label_BestScore_GameOver.GetComponent<UILabel>().text = PlayerPrefs.GetInt("StrokeGrade_9", 0).ToString();
        }
        else
        {
            Label_BestScore.GetComponent<UILabel>().text = PlayerPrefs.GetInt("TimeGrade_9", 0).ToString();
            Label_BestScore_GameOver.GetComponent<UILabel>().text = PlayerPrefs.GetInt("TimeGrade_9", 0).ToString();
        }
        Create();//创建原始状态
        Check();
    ...
    void UpdateScoreAndStroke(int num)
    {
        ...
        if (score > int.Parse(Label_BestScore.GetComponent<UILabel>().text))
        {
            if (isStrokeMode)
            {
                PlayerPrefs.SetInt("StrokeGrade_9", score);
                Label_BestScore.GetComponent<UILabel>().text = score.ToString();
            }
            else
            {
                PlayerPrefs.SetInt("TimeGrade_9", score);
                Label_BestScore.GetComponent<UILabel>().text = score.ToString();
            }
